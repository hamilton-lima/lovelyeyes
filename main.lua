...
--
-- adpated from the LOVE example framework

love.filesystem.require("lovelyeyes/all.lua")
...
function load()
	...
	local unused1, unused2, n = string.find(v, "le(%d%d%d%d)%.lua")
	if n then
...
function List:draw()
    ...
    -- Border.
    love.graphics.setColor(72, 131, 168)
    love.graphics.rectangle(love.draw_line, self.x+self.width, self.y, 
